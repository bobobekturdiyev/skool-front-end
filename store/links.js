...
export const useLinkStore = defineStore("link", () => {
  ...
  function createLink() {
    ...
    axios
      .post(baseUrl + `add-link`, formData, {
        headers: {
  ...
  function updateLink() {
    ...
    axios
      .put(baseUrl + `update-link/${store.link_id}`, formData, {
        headers: {
          Authorization: "Bearer " + token,
        },
      })
  ...
  function getLinks() {
    ...
    axios
      .get(baseUrl + `get-links/${username}`, {
        headers: {
          Authorization: "Bearer " + token,
        },
      })
  ...
  function deleteLink() {
    ...
    axios
      .delete(baseUrl + `delete-link/${store.link_id}`, {
        headers: {
          Authorization: "Bearer " + token,
        },
      })
