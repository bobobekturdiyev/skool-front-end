            ...
            <div class="full_flex gap-4">
              <div class="full_flex items-start gap-4">
                ...
                <div>
                  ...
                  <p>
                    <span class="capitalize">{{ i.group_type }}</span> •
                    <span class="capitalize">
                      {{
                        i.members + `${i.members > 1 ? " members" : " member"}`
                      }}
                    </span>
                  </p>
                </div>
          ...
          <div class="space-y-3 py-5">
            ...
            <button class="full_flex gap-1 b_cf2 h-7 px-2 r_8">
              <img
                ...
                alt=""
              />
              Joined {{ formatDate(useProfile.store.profile.user?.created_at) }}
            </button>
            <button
              v-if="useProfile.store.profile.user?.address"
              class="full_flex gap-1 b_cf2 h-7 px-2 r_8"
            >
              <img
                class="h-4 w-4"
                ...
                alt=""
              />
              {{ useProfile.store.profile.user?.address }}
            </button>
          </div>
