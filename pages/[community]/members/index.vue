    ...
    <div class="w-full">
      <nav class="flex items-center xl:flex-row flex-col-reverse xl:gap-0 gap-6 whitespace-nowrap justify-between mt-5">
        <div class="flex gap-3 mr-auto">
          <button class="py-2 px-3 rounded-full b_cbc hover:bg-[#BCDEFF] hover:bg-opacity-30 duration-700">
            Active <span>0</span>
          </button>
          <button class="py-2 px-3 rounded-full bg-white hover:bg-[#BCDEFF] hover:bg-opacity-30 duration-700">
            ...
            <template #dropdown>
              <el-dropdown-menu class="min-w-[328px] filter_dropdown dropdown_shadow 2xl:!-ml-[60px]">
                <div class="flex items-center mb-6 justify-between">
                  ...
                  <button class="uppercase font-semibold text-sm _c07 b_cbc h-10 px-6 r_8">apply</button>
                </div>
                <div class="flex">
      ...
      <section v-if="isLoading.isLoadingType('groupMembes')" class="space-y-3 mt-5">
        <div class="h-[248px] w-full bg-gray-700 animate-pulse rounded-xl"></div>
        <div v-for="i in 5" class="h-[166px] w-full bg-gray-700 animate-pulse rounded-xl"></div>
      </section>
      <section class="space-y-3 mt-5 w-full" v-else>
        <article data-aos="zoom-in" class="relative md:flex r_16 overflow-hidden p-4 bg-white">
          <div class="w-full">
            <div class="flex items-start justify-between w-full">
              <div class="flex items-start gap-4">
                <el-dropdown placement="top-start" class="dropdown">
                  <div class="relative max-w-fit min-w-[40px]">
                    <img class="h-10 w-10 object-cover rounded-full" :src="useMembers.store.members.user?.image" alt="" />
                          ...
                          <div class="relative user_img max-w-fit">
                            ...
                            <div class="full_flex absolute -bottom-[2px] -right-[5px] z-10">
                              <div class="relative">
                                ...
                                <p class="absolute full_flex bottom-0 w-10 h-10 pb-2 text-[22px] text-white font-medium">
                                  1
                                </p>
                              </div>
                            </div>
                ...
                <div class="space-y-[26px]">
                  ...
                  <div>
                    ...
                    <div class="md:flex gap-[128px] whitespace-nowrap mt-3 text-sm">
                      <div class="space-y-3">
        ...
        <article v-for="i in useMembers.store.members?.members?.data" data-aos="zoom-in"
          ...
          <div class="w-full">
            <div class="flex items-start justify-between w-full">
              <div class="flex items-start gap-4">
                <el-dropdown placement="top-start" class="dropdown">
                  <div class="relative max-w-fit min-w-[40px]">
                    <img class="h-10 w-10 object-cover rounded-full" :src="i.image" alt="" />
                    <div class="full_flex absolute -bottom-[2px] -right-[5px] z-10">
                      <div class="relative">
                        <img src="@/assets/svg/community/user_messages.svg" alt="" />
                        <p class="absolute full_flex bottom-0 w-5 h-5 pb-0.5 text-[10px] text-white font-medium">
