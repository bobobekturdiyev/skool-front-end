              ...
              >
                ...
                <div class="flex">
                  <div class="w-[150px] border-r border-[#E0E0E0]">
                    <h1 class="text-sm font-medium px-8 mb-2">{{ $t("members.status") }}</h1>
                    <el-dropdown-item
                      class="flex items-center _c07 !px-8 font-medium gap-3 h-[44px] !text-xs"
                    >
                      <el-checkbox class="members_checkbox" :label="$t('about.admins')" />
                    </el-dropdown-item>
                    <el-dropdown-item
                      class="flex items-center _c07 !px-8 font-medium gap-3 h-[44px] !text-xs"
                    >
                      <el-checkbox class="members_checkbox" :label="$t('online')" />
                    </el-dropdown-item>
                  </div>
                  <div class="w-[150px]">
                    ...
                    <el-dropdown-item
                      class="flex items-center _c07 !px-8 font-medium gap-3 h-[44px] !text-xs"
                    >
                      <el-checkbox class="members_checkbox capitalize" :label="$t('nav.free')" />
                    </el-dropdown-item>
                  </div>
                  <div class="w-[150px]">
                    <h1 class="text-sm font-medium px-8 mb-2">{{ $t("members.courses") }}</h1>
                    <el-dropdown-item
                      class="flex items-center _c07 !px-8 font-medium gap-3 h-[44px] !text-xs"
                    >
                      <el-checkbox
                  ...
                  <div class="w-[150px]">
                    <h1 class="text-sm font-medium px-8 mb-2">{{ $t("members.sort") }}</h1>
                    <el-dropdown-item
                      class="flex items-center _c07 !px-8 font-medium gap-3 h-[44px] !text-xs"
                    >
                      <input
                    ...
                    >
                      <input
                        ...
                        name="price"
                      />
                      <label for="price_private">{{ $t("members.most") }}</label>
                    </el-dropdown-item>
                  </div>
                </div>
              </el-dropdown-menu>
                  ...
                  <div>
                    ...
                    >
                      ...
                      >
                        ...
                        />
                        <span class="max-w-[80%]"
                          >Joined {{ formatDate(member.created_at) }}</span
                        >
                      </button>
                      <button
