  ...
  <section>
    <div class="grid md:grid-cols-3 grid-cols-2 gap-6 justify-between my-8 mt-[18px]">
      ...
      <div v-else v-for="(i, index) in useClassroom.store.classrooms" data-aos="zoom-in"
        ...
        <div>
          <div>
            <img v-if="i.image" class="w-full card md:h-[180px] sm:h-[140px] h-[88px] object-cover" :src="i.image"
              alt="" />
        ...
        <div class="p-4">
          ...
          <p v-html="i.description" class="md:text-[16px] text-[10px] mt-4 md:mb-7 mb-4 h-12 line-clamp-2">
          </p>
